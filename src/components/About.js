        ...
        <div className='row'>
            <div className="col-md-6">
                <div className="card">
                    ...
                    <p>
                        This application is a personal portfolio website showcasing my software engineering skills, experience, and education. It is built using React, Next.js for backend APIs, Bootstrap 4.6.2, Auth0 for authentication, and hosted on Vercel.
                    </p>
                    </div>
                </div>
            </div>
